...
Public Class CryRptServiceSSI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RE_X.CryRptServiceSSI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRptServiceSSI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRptServiceSSI = New CryRptServiceSSI()
        rpt.Site = Me.Site
        Return rpt
    End Function
