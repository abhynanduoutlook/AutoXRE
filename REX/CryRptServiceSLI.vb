...
Public Class CryRptServiceSLI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RE_X.CryRptServiceSLI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryRptServiceSLI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryRptServiceSLI = New CryRptServiceSLI()
        rpt.Site = Me.Site
        Return rpt
    End Function
